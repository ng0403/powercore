...
<div id="title">
<div class="caption">● 심사부적합으로 처리하시겠습니다? <br><br></div>
</div>

<form method="get" id="leadUnSuitState"><br>
<input type="hidden" id="cust_id" name="cust_id" value="${cust_id}"/>
	<div class="leadChange_bt_position"> 
			<input type="button" class="btn btn-success" value="확인" id="unsuit_confirm"/>
			<input type="button" class="btn btn-default" value="취소" id="unsuit_cancel"/>
	</div>
</form>
</div>
</body>
