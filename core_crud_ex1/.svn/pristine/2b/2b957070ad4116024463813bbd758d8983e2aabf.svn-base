...
<div id="title">
<div class="caption">● 리드추가 <br><br></div>
</div>
...
<div class="bt_position_popup">
	...
	<div class="leadChange_bt_position"> <br><br>
		<input type="button" class="btn btn-success" value="확인" id="leadCandP_confirm" 
		                   onclick="javascript:leadSelect();"/>
		<input type="button" class="btn btn-default" value="취소" id="leadCandP_cancel"
						   onclick="javascript:leadSelectCancel();"/>
	</div>
</form>
</div>
</body>
